...
export default Ember.Controller.extend({
  ...
  actions: {
    ...
    watchVideo: function() {
      Ember.$('body').addClass('video-playing room');
      this.get('roomVideo').playVideo();
    },

    closeVideo: function() {
      Ember.$('body').removeClass('video-playing room account');
      this.get('roomVideo').pauseVideo();
      this.get('accountVideo').pauseVideo();
    },

    watchAccountVideo: function() {
      Ember.$('body').addClass('video-playing account');
      this.get('accountVideo').playVideo();
    }
  },
