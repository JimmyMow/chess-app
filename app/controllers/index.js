...
export default Ember.Controller.extend({
  screenshotData: [{ url: window.location.href + '/assets/images/marketing/screen_shot_one.png', dataSize: '1997x1024', before: false, after: false, content: null, caption: "Jack Mallers (top) is reviewing a game of his with Zach Zuber (bottom)" }],
  whyLearnChessData: [
